...
export async function updateApp(
  ...
  data.id = id;
  return requestClient.put(`/${sysApi}/sys/app`, data);
}
...
export async function deleteApp(id: string) {
  return requestClient.delete(`/${sysApi}/sys/app`, [id]);
}
...
export async function updateFunc(id: string, data: SystemAppApi.Func) {
  data.id = id;
  return requestClient.put(`/${sysApi}/sys/function`, data);
}
...
export async function deleteFunc(id: string) {
  return requestClient.delete(`/${sysApi}/sys/function`, [id]);
}
...
export async function deleteLog(ids: string[]) {
  return requestClient.delete(`/${sysApi}/sys/app/deleteLog`, ids);
}
